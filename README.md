<p align="center">
  <img src="https://raw.githubusercontent.com/homielab/giapha-os/main/public/icon.png" alt="Nguyễn Tộc Icon" width="100" height="100" style="border-radius: 22%; border: 0.5px solid rgba(0,0,0,0.1);" />
</p>

# Nguyễn Tộc (Gia Phả Open Source)
...
3. Điền các biến môi trường đã lưu ở **bước 1**:
   ...
   - `RESEND_FROM_EMAIL` = địa chỉ gửi đã xác minh domain trên Resend, ví dụ `Nguyễn Tộc <no-reply@your-domain.com>`
